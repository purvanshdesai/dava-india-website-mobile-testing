  ...
  return (
    <div className='relative pl-3 pr-3'>
      ...
      >
        ...
        {/* <CarouselPrevious className='absolute left-[2rem] top-1/2 z-10 -translate-y-1/2 transform' />
        <CarouselNext className='absolute right-[2rem] top-1/2 z-10 -translate-y-1/2 transform' /> */}

        <div className='absolute bottom-3 left-1/2 right-1/2 flex items-center justify-center gap-2 duration-300'>
